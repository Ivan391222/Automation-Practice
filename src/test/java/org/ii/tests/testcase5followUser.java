...
public class testcase5followUser extends BaseTest {
    ...
    public void fullTest() throws InterruptedException {
        userPage.login("Kon3884", "1mamDv0ikanatestA");
        userPage.clickUserLora();
        Thread.sleep(3000);
        userPage.followUser();
        Thread.sleep(3000);
        userPage.likePost();
        Thread.sleep(3000);
        Assert.assertTrue(userPage.isPostLiked(), "Post was not liked successfully.");
    }
